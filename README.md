...
Open toolchain for processing infectious disease datasets available through [IIDDA](https://github.com/canmod/iidda) and other repositories. The toolchain contains [R packages and code](R/README.md) and [Python packages and code](python/README.md).
